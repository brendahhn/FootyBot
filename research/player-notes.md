...
# Player notes — draft-relevant status board (2026)

Per-player situational notes (legal, injury, role, offseason moves) that don't fit the
coach-tendencies or breakout-comps files. Created 2026-07-07 (the notebook flagged this file
should exist "if the per-player-status pattern recurs" — it did, several at once). WebSearch-
sourced; tiers per FootyBot discipline (A = well-sourced fact, B = thin/single-source,
C = inference, Speculative = labeled). **Re-verify at camp (late July) and again pre-draft** —
statuses move. Each entry dated so staleness is visible.

## Legal / conduct (live suspension risk)

- **Josh Jacobs (GB RB) — LIVE RISK, unresolved.** [A on facts] Arrested late May 2026, five
  charges incl. felony strangulation (DV); released, Brown County DA has **not** filed a
  charging decision ("open and ongoing"). No charges / no NFL discipline yet; back practicing,
  denies it. Workhorse RB1 (929 yд/13 TD 2025) carrying **unpriced personal-conduct/suspension
  tail-risk**. Watch Brown County news through August. *(NFL.com, ESPN — 2026-07-07)*
- **Rashee Rice (KC WR) — CLEARED, scare is stale.** [A] Served his 5-game suspension at the
  start of 2025 (2024 street-racing case); separate 30-day jail stint this May (probation/THC)
  done; NFL **closed conduct investigation, no further discipline**. Off offseason knee surgery,
  expected ready for camp. Don't fade over the legal headline — real risks are the knee + crowded
  KC target tree. *(NFL.com, ESPN — 2026-07-07)*
- **Puka Nacua (LAR WR) — off-field lawsuit "under review," mild suspension risk.** [B] An
  off-field lawsuit + rehab created a possible 1-6 game suspension scenario; NFL called it a
  "matter under review" with **no ruling** as of April 2026 reporting — Week 1 currently expected
  safe. Flag it, don't overweight it. *(SI, Pro Football Network — via 2026-07-07 search)*

## Injury (2026 availability)

- **Patrick Mahomes (KC QB) — torn ACL+LCL Dec 14 2025, surgery done, tracking to Week 1 with no
  restrictions.** [A] Going ~QB11 in early drafts. In a 6pt-passing-TD league that's a value on a
  top-3 talent *if* camp clears him — R5-6 QB-window target. *(ESPN, CBS, NFL.com — 2026-07-07)*
- **Tyreek Hill (WR, FA) — released by Miami Feb 2026, still unsigned, multi-ligament knee tear;
  uncertain to play at all in 2026.** [A] Effectively undraftable in a 10-team redraft. *(NFL.com,
  ProFootballRumors — 2026-07-07)*
- **Malik Nabers (NYG WR) — torn ACL + meniscus.** [B] Timeline ranges camp-ready to missing
  Week 1. Post-injury archetype = worst league-wide + Brendan's 0-for-6 leak; will fall past ADP.
  Trap, not value, at his discount. *(search synthesis — 2026-07-07)*

## Role / offseason moves (fantasy-relevant)

- **George Pickens (DAL WR) — traded PIT→DAL, franchise-tagged (~$27.3M, 1yr, no extension).**
  [A] WR2 opposite CeeDee Lamb in a high-volume Dak offense, off a 93/1,429/9 2025. Strong
  WR2/flex; Lamb's target share is the only ceiling cap; contract year = motivation. *(Cowboys.com,
  ESPN, NFL.com — 2026-07-07)*
- **A.J. Brown (WR) — traded PHI→NE (June 2026).** [A/B] New team, QB Drake Maye; ADP slid to
  ~pick 18 on the offense downgrade. Makes **DeVonta Smith the unambiguous Eagles WR1** (rising,
  ADP ~25 — a value at Brendan's pick 24). *(ESPN, NBC, PFN — 2026-07-07)* (Consistent with the
  Eagles entry in `coach-tendencies.md`.)
- **Jaxon Smith-Njigba (SEA WR) — 2025 OPOY, Seattle won Super Bowl 60.** [B+] 119/1,793/10,
  35.7% target share, now highest-paid WR; some outlets call him overall WR1. Rising into the
  pick 3-4 conversation — most on-profile pick on the board for Dylan (breakout-chaser) at pick 3,
  so likely gone before Brendan's 4. Cleanest elite-WR profile (no target-competition tax like
  Puka's Davante Adams, no age cliff like CMC). *(fantasylife, RotoWire — 2026-07-07)*
- **Christian McCaffrey (SF RB) — healthy 2025 (17 games, ~2,126 scrim yд, 17 TD, Comeback POY,
  top-2 RB), but age-30 in 2026 off a league-leading 413 touches.** [A] Real ADP slid to ~6-8 on
  a (correctly-priced) age/workload bust narrative; SF wants to cut his workload, he wants volume.
  **NOT a clean POST_INJURY flag for 2026** (played 17 games) — the caution is actuarial, not the
  literal 0-for-6 archetype. Pass at pick 4. *(CBS, Footballguys, ESPN — 2026-07-07)*
- **Ashton Jeanty (LV RB) — disappointing rookie 2025 (14.3 PPG vs 16-17 expected); ADP corrected
  to ~RB5 / pick 12.** [B] A 2nd-year bounce-back bet = Brendan's SECOND_YEAR leak; demand an
  extra round of discount. *(fantasysp, PFN — 2026-07-07)*
- **Jayden Daniels (WAS QB) — lost most of 2025 to injury.** [B] A post-injury discount QB; lower
  archetype-risk at QB than RB/WR but still demand the discount. *(search synthesis — 2026-07-07)*
